...
<head>
  ...
  <title>CRUD en Laravel :: Developer Edward Rodriguez</title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-dark fixed-top" style="background-color: #563d7c !important;">
    <ul class="navbar-nav mr-auto collapse navbar-collapse">
      <li class="nav-item active">
        <a href="{{ ('/') }}"> 
          <img src="{{ asset('img/logo-mywebsite.svg') }}" alt="Developer Edward Rodriguez" width="120">
        </a>
      </li>
    </ul>
    <div class="my-2 my-lg-0" id="maquinaescribir">
      <h5 class="navbar-brand">Developer Edward Rodriguez <span>&#160;</span></h5>
    </div>
</nav>
...
<div class="container mt-5 p-5">
  ...
  <h4 class="text-center">
    CRUD con Ventana Modal en 
    <img src="{{ asset('img/laravel.png') }}" alt="Logo"  style="width: 120px;">
  </h4>
  <hr>

    <p>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createChildren">
            <i class="zmdi zmdi-account-add zmdi-hc-lg" title="Agregar"></i> Agregar Registro
        </button>
    </p>
...
<div class="row text-center" style="background-color: #cecece">
  <div class="col-md-12"> 
    <strong>Lista de Niñ@s <span style="color: crimson">  ({{ $total }})</span> </strong>
  </div>
</div>
